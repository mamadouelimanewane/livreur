  ...
  sections: [
    {
      ...
      content: `L'utilisateur a demandé une analyse complète de l'application LiviGo et un rapport des différentes fonctions.
...
10. mobileService.js - Apps mobiles`
    },
    {
      ...
      content: `15 fonctionnalités supplémentaires proposées:
...
15. OBJECTIFS ET BONUS CONDUCTEUR
    ...
    },
    {
      ...
      content: `14 NOUVEAUX SERVICES API CRÉÉS:
...
• AnalyticsPage.jsx - Dashboard analytics avancé
• ScheduledRidesPage.jsx - Gestion courses programmées
• DriverBonusesPage.jsx - Gestion bonus conducteurs
...
• Imports mis à jour`
    },
    {
      ...
      content: `42 FONCTIONS ORIGINALES TESTÉES:
...
• Compatibilité: ✓ 100% rétrocompatible`
    },
    {
      ...
      content: `COMPOSANTS GÉOLOCALISATION:
...
async function generateWordDocument() {
  ...
  children.push(
    new Paragraph({
      text: `Date: ${discussionContent.date}`,
      alignment: AlignmentType.CENTER,
      spacing: { after: 400 },
    })
  );
  ...
  fs.writeFileSync(path.join(outputDir, 'LiviGo-Rapport-Complet.docx'), buffer);

  console.log('✅ Fichier Word créé: docs/LiviGo-Rapport-Complet.docx');
